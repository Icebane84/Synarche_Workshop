...
- `AsyncMigrationManager`: Main orchestrator
  - Loads 15 up migrations + 15 down migrations (hard-coded in **init**; migrations 11-12 add credential system, 13 adds model-credential link, 14 adds podcast model registry fields, 15 adds the flexible `config` object to the credential table)
