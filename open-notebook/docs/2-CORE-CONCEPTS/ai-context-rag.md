...
| :---------------- | :---------------------------- | :---------------- |
| **Artifact ID**   | `GVRN-AI-CONTEXT-RAG-001`     | The Sovereign ID. |
| **Official Name** | `ai-context-rag.md`           | The Filename.     |
...
- The insight: _Search your content, find relevant pieces, send only those_
