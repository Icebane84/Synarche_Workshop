  ...
  return useMutation({
    ...
    onError: (error: unknown) => {
      toast({
        ...
        description: t(getApiErrorKey(error, 'sources.failedToAddSource')),
        variant: 'destructive',
      })
    },
  })
...
export function useUpdateSource() {
  ...
  return useMutation({
    ...
    onError: (error: unknown) => {
      toast({
        title: t('common.error'),
        description: t(getApiErrorKey(error, 'sources.failedToUpdateSource')),
        variant: 'destructive',
      })
    },
  })
...
export function useDeleteSource() {
  ...
  return useMutation({
    ...
    onError: (error: unknown) => {
      toast({
        title: t('common.error'),
        description: t(getApiErrorKey(error, 'sources.failedToDeleteSource')),
        variant: 'destructive',
      })
    },
  })
...
export function useFileUpload() {
  ...
  return useMutation({
    ...
    onError: (error: unknown) => {
      toast({
        title: t('common.error'),
        description: t(getApiErrorKey(error, 'sources.failedToUploadFile')),
        variant: 'destructive',
      })
    },
  })
...
export function useRetrySource() {
  ...
  return useMutation({
    ...
    onError: (error: unknown) => {
      toast({
        title: t('common.error'),
        description: t(getApiErrorKey(error, 'sources.failedToRetry')),
        variant: 'destructive',
      })
    },
  })
...
export function useAddSourcesToNotebook() {
  ...
  return useMutation({
    ...
    onError: (error: unknown) => {
      toast({
        title: t('common.error'),
        description: t(getApiErrorKey(error, 'sources.failedToAddSourcesToNotebook')),
        variant: 'destructive',
      })
    },
  })
...
export function useRemoveSourceFromNotebook() {
  ...
  return useMutation({
    ...
    onError: (error: unknown) => {
      toast({
        title: t('common.error'),
        description: t(getApiErrorKey(error, 'sources.failedToRemoveSourceFromNotebook')),
        variant: 'destructive',
      })
    },
  })
