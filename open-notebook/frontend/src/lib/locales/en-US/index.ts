export const enUS = {
  ...
  settings: {
    ...
    filesHelp:
      "Once your files are uploaded and processed, they are not required anymore. Most users should allow Open Notebook to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    rebuildWarning:
      "This action can be very time-consuming depending on the number of sources you have. It will clear existing vector indices and re-generate embeddings for everything.",
  ...
  models: {
    ...
    changeEmbeddingWarning:
      "Changing the default embedding model will affect new sources. Existing sources might need to be re-indexed.",
    ...
    missingRequiredModels:
      "Missing required models: {models}. Open Notebook may not function properly without these.",
    ...
    addSpecificModelDesc:
      "Configure a new {type} model from available providers.",
