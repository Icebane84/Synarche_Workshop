export const jaJP = {
  ...
  apiErrors: {
    ...
    invalidSortBy:
      "ソートフィールドは'created'または'updated'である必要があります",
  ...
  sources: {
    ...
    allSourcesDesc:
      "すべてのソースを表示します。新しいソースの追加や既存ソースの管理ができます。",
    allSources: "すべてのソース",
    insights: "インサイト",
    yes: "はい",
    no: "いいえ",
    ...
    cannotSaveNoteNoNotebook:
      "ノートを保存できません：ノートブックIDが利用できません",
    createFirstSource:
      "最初のソースを追加してナレッジベースの構築を始めましょう。",
    deleteSourceConfirm: "このソースを削除しますか？",
    deleteConfirm: "削除しますか？",
    deleteConfirmWithTitle: "「{title}」を削除しますか？",
    deleteSuccess:
      "ソースを削除しました。注意：ストレージからファイルを削除するには、設定ページで「ファイルを削除」オプションを有効にする必要があります。",
    ...
    failedToRemoveSourceFromNotebook:
      "ノートブックからのソース削除に失敗しました",
    ...
    htmlDetected:
      "HTMLコンテンツが検出されました。処理後にMarkdownに変換されます。",
    ...
    embeddingDesc:
      "このソースをベクトル検索やAIクエリで見つけられるようにします",
    embeddingAlways: "Embeddingは自動的に有効",
    embeddingAlwaysDesc:
      "設定でベクトル検索用に常にEmbeddingするよう構成されています。",
    ...
    fileUnavailableDesc:
      "ストレージシステムの理由により、このファイルは現在利用できません。",
  ...
  chat: {
    ...
    deleteSessionDesc:
      "このチャットセッションを削除しますか？この操作は元に戻せません。",
  ...
  searchPage: {
    ...
    askYourKbDesc:
      "LLMがナレッジベース内のドキュメントに基づいてクエリに回答します。",
    question: "質問",
  ...
  podcasts: {
    ...
    content: "コンテンツ",
    contentDesc:
      "このエピソードに含めるノートブック、ソース、ノートを選択してください。",
    ...
    selectMode: "モードを選択",
    buildContextFailed:
      "コンテキストの構築に失敗しました。選択内容を確認してください。",
    ...
    listTitle: "ポッドキャスト",
    listDesc:
      "生成されたエピソードを追跡し、再利用可能なテンプレートを管理します。",
    chooseAView: "表示を選択",
    episodesTab: "エピソード",
    templatesTab: "テンプレート",
    ...
    episodeProfilesList2:
      "ブリーフィング、アウトライン、スクリプト作成に使用する言語モデルを選択",
    ...
    speakerProfilesList3:
      "異なるエピソードフォーマットで同じホストやゲストの声を再利用",
    recommendedWorkflow: "推奨ワークフロー",
    workflowStep1: "必要な各声のスピーカープロファイルを作成",
    workflowStep2:
      "それらのスピーカーを名前で参照するエピソードプロファイルを構築",
    workflowStep3:
      "ストーリーに合ったエピソードプロファイルを選択してポッドキャストを生成",
    workflowHint:
  ...
  settings: {
    ...
    filesHelp:
      "ファイルがアップロードされて処理されると、ファイル自体は不要になります。ほとんどのユーザーはOpen Notebookがアップロードフォルダから自動的にファイルを削除することを許可すべきです。",
  ...
  advanced: {
    ...
    rebuildWarning:
      "このアクションはソース数によっては非常に時間がかかる場合があります。既存のベクトルインデックスをクリアし、すべてのEmbeddingを再生成します。",
    startRebuild: "再構築を開始",
    rebuilding: "再構築中...",
    ...
    updateCheckFailed:
      "更新を確認できません。GitHubに接続できない可能性があります。",
    rebuild: {
      mode: "再構築モード",
      existing: "既存のみ",
      all: "すべて",
      existingDesc:
        "すでにEmbeddingがあるアイテムのみ再Embedding（高速、モデル切り替え用）",
      allDesc:
        "既存アイテムの再Embedding＋Embeddingがないアイテムも作成（低速、包括的）",
      include: "再構築に含める",
      ...
      failed: "失敗",
      leavePageHint:
        "バックグラウンドで実行されるため、このページを離れても構いません",
      startNew: "新しい再構築を開始",
  ...
  transformations: {
    ...
    defaultPromptDesc:
      "これはすべてのトランスフォーメーションプロンプトに追加されます",
    defaultPromptPlaceholder:
      "デフォルトのトランスフォーメーション指示を入力...",
    ...
    promptPlaceholder:
      "このトランスフォーメーションを実行するプロンプトを書いてください...",
    descriptionPlaceholder:
      "このトランスフォーメーションの機能を説明してください。",
    ...
    sessionUseReplacement:
      "このセッションはデフォルトモデルの代わりに{name}を使用します。",
  ...
  models: {
    ...
    changeEmbeddingWarning:
      "デフォルトのEmbeddingモデルを変更すると新しいソースに影響します。既存のソースは再インデックスが必要になる場合があります。",
    changeEmbeddingTitle: "デフォルトEmbeddingモデルを変更しますか？",
    aiProviders: "AIプロバイダー",
    providerConfigDesc:
      "環境変数を通じてプロバイダーを設定し、モデルを有効にしてください。",
    ...
    defaultAssignmentsDesc:
      "Open Notebook全体で異なる目的に使用するモデルを設定",
    missingRequiredModels:
      "必須モデルがありません: {models}。これらがないとOpen Notebookが正しく機能しない可能性があります。",
    ...
    addSpecificModelDesc:
      "利用可能なプロバイダーから新しい{type}を設定します。",
    ...
    embeddingChangeConfirm:
      "Embeddingモデルを{from}から{to}に変更しようとしています。",
