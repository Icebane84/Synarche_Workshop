...
export const QUERY_KEYS = {
  ...
  sourcesInfinite: (notebookId: string) =>
    ["sources", "infinite", notebookId] as const,
  source: (id: string) => ["sources", id] as const,
  settings: ["settings"] as const,
  sourceChatSessions: (sourceId: string) =>
    ["source-chat", sourceId, "sessions"] as const,
  sourceChatSession: (sourceId: string, sessionId: string) =>
    ["source-chat", sourceId, "sessions", sessionId] as const,
  notebookChatSessions: (notebookId: string) =>
    ["notebook-chat", notebookId, "sessions"] as const,
  notebookChatSession: (sessionId: string) =>
    ["notebook-chat", "sessions", sessionId] as const,
  podcastEpisodes: ["podcasts", "episodes"] as const,
  podcastEpisode: (episodeId: string) =>
    ["podcasts", "episodes", episodeId] as const,
