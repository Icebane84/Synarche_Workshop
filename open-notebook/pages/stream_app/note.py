...
def note_card(note, notebook_id) -> None:
    icon = "ğŸ¤µ" if note.note_type == "human" else "ğŸ¤–"¤–"
    ...
    with st.container(border=True):
        ...
        if st.button("Expand", icon="ğŸ“", key=f"edit_note_{note.id}"):
...
def note_list_item(note_id, score=None) -> None:
    ...
    with st.expander(
        ...
        if st.button("Edit Note", icon="ğŸ“", key=f"x_edit_note_{note.id}"):
