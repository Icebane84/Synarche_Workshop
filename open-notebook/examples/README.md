...
It also includes an [`easypanel`](./easypanel/) template that can be copied into the official EasyPanel templates
repository and tested in the EasyPanel templates playground.
...
**⚠️ Deprecated:** We recommend using the standard multi-container setup (`docker-compose.yml` in root) for better
reliability and easier troubleshooting.
...
**Setup:** See [Development Guide](../docs/7-DEVELOPMENT/index.md)
