...
| `GVRN.LEARN.Shard`       | `UPDATES`         | Persistent session learnings are stored here.   |
| `GVRN.LEARN.Improvement` | `OPERATIONALIZES` | Formal protocol for recursive optimization.     |

---

## **Block E: Ethos (The Why)**

> **"To enable the Synarche to evolve through its own experience, transmuting every session trace into a permanent
> architectural asset."**
...
The Self-Improvement skill enables the agent to learn from successes and failures, automating project-specific patterns
into reusable skills and preventing regressions. It is the core tool of the **II. High Priestess** for weaving the
**Cognitive Loom**.
...
- **Triggers:**
  ...
  - **Trigger C (Session End):** Prompt for synthesis of new patterns into `GVRN.LEARN.Shard.md`.
...
`[OMNI-ARTIFACT-ANCHOR] ID: SKL.SELF-IMPROVE.GENESIS-001 VER: v15.0 [OMEGA] STATUS: ACTIVE TS: 2026-03-17`
