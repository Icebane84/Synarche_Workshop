...
def scan_skills():
    ...
    for domain in os.listdir(skills_root):
        ...
        if not os.path.isdir(domain_path) or domain == "README.md":
            continue
...
def scan_workflows():
    ...
    for category in os.listdir(workflows_root):
        ...
        if not os.path.isdir(category_path) or category == "README.md":
            continue
        ...
        for wf_file in os.listdir(category_path):
            if wf_file.endswith(".md") and wf_file != "README.md":
