/**
<<<<<<< Updated upstream:.agent/substrate/rules/markdownlint/axion-rules.cjs
...
>>>>>>> Stashed changes:axion-core/tools/rules/axion-rules.cjs
 */
...
// Fallback/Common prefixes to ensure basic rules don't fail if cspell is missing them
["GUCA", "TEST", "UMB", "AOP", "WLF", "DOC", "CODE", "CHAR", "CMD", "TOOL", "GVRN", "SYNG", "CORE", "ARCH"].forEach((p) => {
    if (!CANONICAL_ACRONYMS.includes(p)) CANONICAL_ACRONYMS.push(p);
>>>>>>> Stashed changes:axion-core/tools/rules/axion-rules.cjs
});
