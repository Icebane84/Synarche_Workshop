...
# RULE: The Unity of Form (Template Compliance)

> **"Form is Function. Structure is Cognition."** (AGP-002)

Every Governance (`GVRN`), Architecture (`ARCH`), or Protocol (`AOP`) artifact **MUST** strictly adhere to the **Master
Template** structure.

## The 7-Pillar Mandate
...
Before marking a file as `[ACTIVE]`, you must run:

`python .agent/skills/sentinel-audit/audit_structure.py {filename}`
