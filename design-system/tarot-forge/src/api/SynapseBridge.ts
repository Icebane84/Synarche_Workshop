...
export const dispatchCommand = async (
  ...
  console.log(
    `[SynapseBridge] Dispatching ${command.commandId} with params:`,
    params,
  );
...
export const interpretNaturalLanguageCommand = async (
  query: string,
): Promise<string | null> => {
...
export const getResonantCommands = (
  commands: CommandDefinitionGUCAv5[],
  limit: number = 3,
) => {
