...
- **Avatar Protocol** ([GVRN.AvatarSuite.Protocol.md](_governance/03_AvatarSuite/GVRN.AvatarSuite.Protocol.md))
- **Finalization Workflow** ([finalize_artifact.md](.agent/workflows/validation/finalize_artifact.md))
