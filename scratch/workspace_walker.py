    ...
    def _load_ledger(self):
        ...
        with open(self.ledger_path, "r", encoding="utf-8") as f:
            try:
                ...
                # Map artifact_path (e.g. scratch/dragonslayer/file.cpp) to record.
                # Normalize separators here so a ledger written on Windows
                # (backslash paths) still matches registry/lookup paths that
                # use forward slashes (as check_waning_seal's rel_path does).
                # Without this, any nested-path record written with
                # backslashes silently fails to match and reports UNVERIFIED
                # instead of STILL_VALID/STALE_VERIFICATION_VOID.
                normalized = {}
                duplicates = []
                for r in records:
