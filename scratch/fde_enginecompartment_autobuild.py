...
FDE_STRUCTURE = {
    ...
    "core": ["engine_runtime.py", "chunk_executor.py", "rollback_core.py", "delta_packet.py"],
    "ecs": ["entity_registry.py", "archetype_storage.py", "world.py", "commit_layer.py", "ecs_scheduler.py"],
...
def forge_repository():
    ...
    with open(readme_path, "w", encoding="utf-8") as f:
        f.write("# The Phoenix Full Deterministic Engine (FDE)\n\n"
