...
# Sovereign UAM Ontological Lexicon Registry
# UIP-V15 Protocol Controlled Semantic Namespace
# Prevents semantic collisions and defines strict boundaries for AI and human alignment

ONTOLOGICAL_LEXICON = {
    "LEX-EXEC-001": {
        "term": "The Forge",
        "canonical_equivalent": ["CI_PIPELINE", "BUILD_SYSTEM"],
        "classification": {
            "domain": "INFRA",
    ...
    "LEX-GVRN-001": {
        "term": "Sentinel Gate",
        "canonical_equivalent": ["CI_VALIDATION_GATE", "STATIC_ANALYSIS_HOOK"],
        "classification": {
            "domain": "GVRN",
    ...
    "LEX-CORE-001": {
        ...
        "canonical_equivalent": ["REFACTOR_TICKET", "BUG_DEBUG_SESSION"],
        "classification": {
            "domain": "CORE",
    ...
    "LEX-COGN-001": {
        ...
        "canonical_equivalent": ["RUNTIME_INTERRUPT", "ERROR_HALT"],
        "classification": {
            "domain": "CORE",
    ...
    "LEX-NET-001": {
        "term": "Synapse",
        "canonical_equivalent": ["MESSAGE_BUS", "EVENT_BROKER"],
        "classification": {
            "domain": "FABRIC",
    ...
    "LEX-COMP-001": {
        "term": "Sophia",
        "canonical_equivalent": ["ORCHESTRATION_INTELLIGENCE", "COMPILER_FLOW"],
        "classification": {
            "domain": "COMPUTE",
    ...
    "LEX-METR-001": {
        "term": "Coherence",
        "canonical_equivalent": ["STRUCTURAL_ALIGNMENT_METRIC", "SELF_CONSISTENCY"],
        "classification": {
            "domain": "GVRN",
