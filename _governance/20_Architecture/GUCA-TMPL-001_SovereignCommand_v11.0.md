...
---
UIP: GUCA-TMPL-001
Title: Master Sovereign Command Template
Source: 
...
| Field              | Value                                            |
| :----------------- | :----------------------------------------------- |
| **Command ID**     | `GUCA-XXX-001`                                   |
| **Creation Date**  | `YYYY-MM-DD`                                     |
| **Canonical Path** | `[PHOENIX_PROTOCOL_LIBRARY]/Library/3_Commands/` |
| **Semantic Tags**  | `#command, #executable, #Tag3`                   |
...
> [!TIP]
> **Ability Integration**
> _This command acts as an active spell or ability for the Phoenix Form._
