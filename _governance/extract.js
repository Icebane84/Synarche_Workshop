...
const data = fs.readFileSync("10_Governance/(Needs Refactored) GVRN.MCE.001.md", "utf8");
const lines = data.split("\n");

const artifacts = [
    { name: "GVRN.MCE.001", start: "## AISTF Operational Playbook: Multi-Command Execution Protocol", end: "## Tab 3" },
    {
...
for (const artifact of artifacts) {
    ...
    fs.writeFileSync(`10_Governance/temp_${artifact.name}.md`, content.join("\n"));
}
