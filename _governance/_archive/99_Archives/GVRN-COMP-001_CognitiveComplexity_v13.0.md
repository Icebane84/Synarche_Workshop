...
To move beyond Cyclomatic Complexity (testability) and enforce **Cognitive Complexity** (understandability). High scores
indicate code that is "difficult to reason about," representing a violation of the **Zero Entropy Rule**.
