...
This artifact contains the `ArtifactTransmuter` utility, designed to convert Synarche Markdown artifacts into a
Nicemind-compatible import format. It parses the Governance Blocks (A, D) and transforms them into a mindmap tree
structure.
