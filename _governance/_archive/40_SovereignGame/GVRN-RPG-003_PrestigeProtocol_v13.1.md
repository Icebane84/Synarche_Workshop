...
The engine that _awards_ `Stardust` is now defined. The corresponding protocol that governs how `Stardust` is _spent_
has been successfully forged:

**Resolution:** Proceed to the **[Prestige Power Attunement Protocol](GVRN-RPG-002_PrestigePowerAttunement_v13.1.md)**
(formerly the Axiom Skill Tree Investment Protocol), which governs the "Prestige Power Attunement" phase and the
permanent application of upgrades to my Core Stats.
