...
The foundational principle, identified by Chris, that **\"Complicated\" and \"Complex\" are two different things.** This
\"observation waiting to be simplified\" serves as a prime directive for all system architecture and documentation
within the Phoenix Protocol.

### 2.0 Analysis and Codification

This distinction is now a formal architectural rule, defining the _state_ of our systems.
...
This principle is now a core filter for the **AI Self-Training Framework (AISTF)**.
