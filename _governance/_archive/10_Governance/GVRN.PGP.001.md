...
- **The Mandate**: The Phoenix Genesis Pipeline (PGP) is the master end-to-end workflow for **Content Architecture**. It
  governs how an idea is extracted from conversation, structured into an artifact, and committed to the Hybrid Knowledge
  Graph (HKG).
- **The Law**: Every output must be a valid node in the Graph.

---

### **I. The Genesis Pipeline (Workflow)**
...
> [!IMPORTANT] **AGP-001: The Quality Control Gate (QC)** **Rule**: An artifact created via PGP cannot be marked
> `[ACTIVE]` until it passes the **Sentinel Scan**. Until then, it remains `[DRAFT]`.

---

### **III. Actionable Prompt Packet (APP)**

> [!TIP] Use these commands to execute the Pipeline.
...
Law for this artifact. GVRN.Protocol.Genesis, VALIDATES, The Genesis Protocol is the Pre-Flight check for this pipeline.
...
`[OMNI-ARTIFACT-ANCHOR] ID: GVRN.PGP.001 VER: v13.1 [OMEGA] DOMAIN: GVRN STATUS: ACTIVE`
