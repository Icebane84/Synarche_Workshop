...
UIP: GUCA-MAP-001 Title: Execute Musashi Audit Command Source:
...
Description: > Defines the master command logic for calculating the Musashi Alignment Protocol Integrated Critique Score
