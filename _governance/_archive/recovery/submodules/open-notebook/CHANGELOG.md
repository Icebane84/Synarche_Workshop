...
| :------------------ | :---------------------------- | :---------------- |
| **Artifact ID**     | `GVRN-CHANGELOG-001`          | The Sovereign ID. |
| **Official Name**   | `CHANGELOG.md`                | The Filename.     |
...
- `rebuild_embeddings_command` now delegates to individual embed\_\* commands instead of inline processing
