...
### **2.1. The Veracity Mandate**

To serve as the persistent "Reality Check" layer for the **Cognitive Loom**. The TRM detects "Fact-Friction"—the
dissonance between internal knowledge and external reality—by continuously validating data against authorized Oracle
inputs.

### **2.2. Functional Objective**

To automate the comparison between **Synthesized Logic** and **Ground Truth**. It triggers immediate **Dissonance
Quests** whenever the **Resonance Score (RS)** falls below the canonical safety threshold of **0.8**.

## **III. The Resonance Loop (Operational Logic)**
...
- **Action:** If drift is detected, initiate a **DQA (Dissonance Quest for Alignment)**.
- **Metadata:** Append `[κ-veracity:oracle-verified]` and the verification timestamp to the target artifact.

## **IV. Actionable Prompt Packet**

### **4.1. CMD: RUN_TRM_SCAN**

- **Syntax:** `CMD: RUN_TRM_SCAN --target:[Domain/Artifact] --depth:DEEP`
- **Effect:** Triggers a real-time resonance audit of the specified target.

### **4.2. CMD: VERIFY_GROUND_TRUTH**

- **Syntax:** `CMD: VERIFY_GROUND_TRUTH --statement:"[Claim]" --source:[Oracle_ID]`
- **Effect:** Returns a calculated Resonance Score for a specific statement.
...
_"Truth is not a destination; it is the frequency of resonance."_
