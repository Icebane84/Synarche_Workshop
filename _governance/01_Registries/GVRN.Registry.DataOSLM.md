# GVRN.Registry.DataOSLM (Relational Substrate)
...
| `GVRN.Registry.OSLM`    | `DEFINES`         | Defines the relational grammar for this data.   |
...
> **Signal**: OMEGA — _The Relational Gravity Signature_
...
| `CMD: WEAVE_LINK`     | Build a new synergistic edge     | Graph Density |
| `CMD: REGISTRY_SWEEP` | Full sweep for orphan nodes      | Coherence     |
...
`[OMNI-ARTIFACT-ANCHOR] ID: GVRN.Registry.DataOSLM VER: v15.0 [OMEGA] DOMAIN: GVRN STATUS: CANONIZED TS: 2026-03-21 HASH: DATA-OSLM-V15-ALIGN`
