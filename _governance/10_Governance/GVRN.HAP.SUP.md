...
> - **Relations:** `LINK: UMB-LOOM-005`, `UTILIZES: Supabase-Postgres`.
...
This protocol governs the bidirectional exchange of high-fidelity memory between the **Axion Core** and the **Supabase** persistence layer. It ensures that discovered insights, conversational context, and system state are stored with absolute integrity and accessibility.
...
2. **Zero-Latency Weave:** The agent utilizes the **ContextWeave Engine** (`AOP-CW-001`) to pre-process data before commit.
