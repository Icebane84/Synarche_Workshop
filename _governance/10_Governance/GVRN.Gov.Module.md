...
| :---------------- | :-------------------------------- | :---------------- |
| **Artifact ID**   | `GVRN.Gov.Module` | The Sovereign ID. |
| **Official Name** | `GVRN.Gov.Module.md` | The Filename.     |
...
`[OMNI-ARTIFACT-ANCHOR] ID: GVRN.Gov.Module VER: v14.0 [OMEGA] DOMAIN: GVRN STATUS: CANONIZED TS: 2026-03-15 HASH: 3769C3C6380C8ADD`
