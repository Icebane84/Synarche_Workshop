...
> [!IMPORTANT]
> **AGP-001: The Quality Control Gate (QC)**
> **Rule**: An artifact created via PGP cannot be marked `[ACTIVE]` until it passes the **Sentinel Scan**. Until then, it remains `[DRAFT]`.
...
GVRN.Protocol.Genesis, VALIDATES, The Genesis Protocol is the Pre-Flight check for this pipeline.
