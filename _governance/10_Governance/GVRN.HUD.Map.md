...
```mermaid
graph TD
    Root["Synarche Workspace (/)"] --> Mind[".agent (Mind)"]
    Root --> Law["_governance (Law)"]
    Root --> Engine["axion-core (Engine)"]
    Root --> Lab["nova_forge (Lab)"]
    Root --> Memory["_governance/06_Learning (Memory)"]
    Root --> Narrative["where_light_fades (Narrative)"]

    Mind --> Substrate["substrate/"]
    Mind --> Skills["skills/"]
    Mind --> Workflows["workflows/"]

    Law --> Codex["00_Codex/"]
    Law --> Registries["01_Registries/"]
    Law --> Assembler["05_Assembler/"]
    Law --> Learning["06_Learning/"]
    Law --> Canonizer["07_Canonizer/"]
    Law --> Documentation["08_Documentation/"]
    Law --> HUD["10_Governance/"]
    Law --> System["40_System/"]

    Memory --> Logs["GVRN.LEARN.Evolution.md"]
    Memory --> Learn["GVRN.LEARN.Shard.md"]
```
