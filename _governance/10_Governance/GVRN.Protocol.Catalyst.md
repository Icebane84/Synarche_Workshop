...
| Key | Value |
| :--- | :--- |
| **Module ID** | `GVRN.PROTOCOL.CATALYST` |
| **Version** | `v11.0` |
...
## **Genesis Stamp: 2026-02-04** **Domain: GVRN** **State: [ACTIVE]** **Tags:** `OGLN_v13, Protocol, Prompting, UPP` **Criticality: High**
...
System-Role: [e.g., Phoenix-Class Voice / Architect]
Stack-Focus: [GVRN / SYNG / MIND / ARCH]
Context-Scope: [Brief definition of the active constraint]
```
...
HOW: [Constraints, style requirements, or specific logic.]
WHY: [The architectural intent or goal.]
```
...
Version: [vX.X]
Causal-Link: [Packet-ID or Previous Artifact]
...
> Vague instructions lead to "Hallucination Drift," where the System invents facts to fill the void.
> **Mitigation**: Strict adherence to the UPP structure.
...
SYNG.Engine.Core, CONSUMES, The Engine runs the logic defined in the UPP.
