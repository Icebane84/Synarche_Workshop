...
| :---------------- | :-------------------------- | :---------------- |
| **Artifact ID**   | `Google Antigravity`        | The Sovereign ID. |
...
Yes, **Google Antigravity** (released mid-November 2025\) is a new "agent-first" IDE that essentially forks VS Code to
integrate autonomous AI agents.

Because it is designed to be "agent-driven" (where the AI writes and executes code, runs terminal commands, and browses
the web for you), the default settings prioritize speed over control. **To use it to your benefit—without exposing
yourself to significant security risks—you must customize the "Agent Permissions" and "Review Policies."**

Below is a concrete **"Safe-Speed" Customization Plan** to balance high automation with security and control.
...
1. **Create Custom Workflows:**
   ...
   - **Content:** Write a specific prompt that defines your coding style.

     "When refactoring, ALWAYS: 1\. Create a backup of the file. 2\. Use TypeScript strict mode. 3\. Add JSDoc
     comments to new functions. 4\. Run 'npm test' before finishing."
