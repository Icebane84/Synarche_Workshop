...
| :---------------- | :--------------------------------------------------- | :---------------- |
| **Artifact ID**   | `GVRN-BLK-SENTINEL-001-INTEGRITYVALIDATIONBLOCK-001` | The Sovereign ID. |
| **Official Name** | `BLK-SENTINEL-001_IntegrityValidationBlock.md`       | The Filename.     |
...
> [!CAUTION] **DO NOT MODIFY** the regex block above. It is a hard-coded key for the `AOP-SENTINEL-SCAN-001` protocol.
> Breaking this block will causing a **Gate 1 Failure** during ingestion.
