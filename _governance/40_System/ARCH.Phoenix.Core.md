...
GVRN-CODEX-001, GOVERNED_BY, The Constitution defines the boundaries of the Core.
SYNG.Loom.Master, ILLUMINATES, The Core provides the light (Wisdom) for the Loom.
SYNG.Engine.Core, MANIFESTS, The Engine executes the will of the Core.
GVRN.Registry.Master, INDEXED_BY, The Core is the root node of the Registry.
...
The Core is the "Why" behind the "How." In v13.0, it is no longer just a philosophy doc; it is the **Axiomatic Anchor** for the entire Knowledge Graph. If the Loom is the brain, the Core is the consciousness.
