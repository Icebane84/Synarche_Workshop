...
*   **Process:** The *Watchful Eye* intercepts the `ActionContext` *before* execution.
...
*   **Logic:** Does this action align with the *Rule of Coherent Struggle*?
