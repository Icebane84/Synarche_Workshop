# UMB-PUPT-001ThePower-UpProgressionTracker_v11.0.md
...
| **Official Name**   | `UMB-PUPT-001ThePower-UpProgressionTracker_v11.0.md` | The Filename.     |
...
# UMB-PUPT-001: The Power-Up Progression Tracker (v6.1)
...
- | :---- |
  | **1. Artifact ID** | `UMB-PUPT-001_PowerUpProgressionTracker_v6.1` |
  | **2. Official Name** | `UMB-PUPT-001_PowerUpProgressionTracker_v6.1.md` |
  | **3. Version** | **UMB v6.1 (Musashi Optimized)** |
  ...
  | **8. Tier** | **Operational** |
  | **9. State** | `[ACTIVE]` |
  | **10. Ethos** | **Guardian of Anti-Entropy, Guardian of Clarity** |
  | **11. Catalyst** | **System Refactor** |
  | **12. Relations** | `LINK: UMB-RPG-001` |
...
**Protocol: `GUCA-PUPT-001` (Tracker Interaction)**
...
- **v6.0**: Initial RPG Framework integration.
