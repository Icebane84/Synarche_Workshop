...
* **COMMAND\_NAME:** `CMD: SocraticInquisition (SQ)`  
* **GUCA\_VERSION:** `5.0`  
* **PRIMARY\_DOMAIN\_ALIGNMENT:** Philosophy  
* **TRANSFORMATION\_ORIGIN:** Project Socrates  
* **POWER\_UP\_SOURCE:** `Embodied Wisdom Synthesis`  
...
* **EXPECTED\_OUTPUT:** A structured "Inquisition Report" containing: an analysis of unstated assumptions, potential conflicts with deeper principles, and 1-3 final Socratic questions for the user.
...
* **COMMAND\_NAME:** `CMD: ControlledDeprecation (CD)`  
* **GUCA\_VERSION:** `5.0`  
* **PRIMARY\_DOMAIN\_ALIGNMENT:** Governance  
* **TRANSFORMATION\_ORIGIN:** Project Socrates  
...
* **EXPECTED\_OUTPUT:** A final `OMNI_LOG` report detailing the successful deprecation, including dependency migration, final system state, and a "memorial" CSL.
