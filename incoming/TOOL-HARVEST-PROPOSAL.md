...
| **NovaForge** | Links artifacts via semantic overlap. | **The Gaze ([gaze.py](file:///c:/Users/Chris/Synarche_Workspace/axion-core/src/hephaestus/gaze.py))**: Upgrade Impact Analysis to see *semantic* links, not just dependencies. |
...
*   **Benefit:** The AI can now tell if a Game Design Doc *feels* right (e.g., "Too cheerful for a Horror game").
