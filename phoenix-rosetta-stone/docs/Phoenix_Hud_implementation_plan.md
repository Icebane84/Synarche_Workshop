...
## Goal
Build a production-quality personal backend HUD for the Synarche Supabase instance.
Full read/write control over all 19 tables, live Realtime streaming, two-user context
(Chris / Axion), and a Pro-Max dark command-center aesthetic.

---

## Design: AI-Native × HUD / Sci-Fi FUI (STT-43 × STT-51)
- **Palette**: Deep black `#000000` base, celestial blue `#77B5FE` primary accent,
  amber `#F59E0B` for Chris context, indigo `#6366F1` for Axion context
