...
export const NeoGenesisView: React.FC = () => {
  ...
  // Player state & Particles inside canvas
  ...
  // Passive Simulation Ticker (Tribal & Galactic Generation)
  useEffect(() => {
      ...
      {activeViewMode === "Cellular" ? (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          <div className="lg:col-span-7 space-y-4">
            <div className="bg-panel-bg/40 border border-cyan-500/30 p-4 rounded-xl space-y-3 shadow-2xl backdrop-blur-md relative overflow-hidden">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {tribalStructures.map((st) => (
                    <div key={st.id} className="bg-deep-space p-3.5 rounded-lg border border-white/5 space-y-2 flex flex-col justify-between">
                  ...
                  return (
                    <div
                      ...
                      className={`p-4 rounded-lg border transition-all duration-200 cursor-pointer flex items-center justify-between ${
                        isSelected ? `${p.color} shadow-lg scale-[1.01]` : "bg-deep-space/60 border-white/5 hover:border-white/20"
                      }`}
                    >
          ...
          <div className="lg:col-span-5 space-y-4">
            <div className="bg-panel-bg/40 border border-cyan-500/40 p-5 rounded-xl space-y-5 shadow-2xl backdrop-blur-md">
              <div className="flex justify-between items-center border-b border-white/10 pb-3">
                ...
                <LivePill label={selectedPlanet.status} type={selectedPlanet.status === "Colonized" ? "active" : "fading"} />
              </div>
