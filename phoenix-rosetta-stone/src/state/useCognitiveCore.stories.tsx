  ...
  return (
    <div className="p-8 bg-black/80 backdrop-blur-md rounded-2xl border border-white/10 text-white font-mono text-sm max-w-3xl">
      ...
      <div className="grid grid-cols-2 gap-8">
        ...
        <div>
          <h3 className="text-white/50 text-xs uppercase mb-2">
            Internal Message Buffer ({messages.length})
          </h3>
...
const meta: Meta<typeof CognitiveStoreVisualizer> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Visualization of the Invisible. This story acts as a diagnostic window into the `useCognitiveCore` Zustand store, fulfilling the XAI requirement for metacognitive observation.",
      },
    },
  },
};
