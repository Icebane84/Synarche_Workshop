...
| **Title** | `Documentation Suite Architect Architecture` | | **Governance** | `UMB-SGM-001` |

---

## II. Purpose

Provides definitive syntax for executing the **Documentation Suite Architect (DSA)** command to auto-generate artifact
suites.
