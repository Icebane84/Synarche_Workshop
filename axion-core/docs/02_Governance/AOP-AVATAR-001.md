...
Synergistic Artifact ID, Relationship Type, Synergistic Impact AOP-AG-003, DEFINES, The Agent Configuration defines the
persona within the Avatar. CHAR-AXION-001, MANIFESTS, The Avatar manifests the Axion persona. agent_template.py,
RUNS_ON, The Python template loads the Avatar protocol.
...
4. **Reward:** Axion grants Prestige (`CMD: AWARD_PRESTIGE`).
