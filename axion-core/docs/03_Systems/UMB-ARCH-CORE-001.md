...
graph TD
    ...
    subgraph Operational_Playbooks
        AOP_SELF_001(AOP: Core Self-Reforging)
        AOP_CAM_001(AOP: Anchor Management)
        AOP_CFO_001(AOP: Flow Optimization)
    end

    CSE -- Manages --> CognitiveLoom
    SIVC -- Audits --> CSE
    CognitiveLoom -- Feeds --> AOP_SELF_001
    AOP_CAM_001 -- Secures --> UCE
    DCLB -- Balances --> UCE
```
