...
class KnowledgeLoom:
                ...
                if in_synergy_table and "," in line:
                    ...
                    if len(parts) >= 2:
                        ...
                        if relation in RelationType.__members__:
                            ...
                            print(f" [OK] Linked: {source_id} --[{relation}]--> {target_id}")
    ...
    def visualize(self):
        ...
        # Draw Nodes
        nx.draw_networkx_nodes(self.graph, pos, node_size=2000, node_color="skyblue", alpha=0.7)
        
        # Draw Edges
        nx.draw_networkx_edges(self.graph, pos, width=1.0, alpha=0.5, edge_color="gray", arrowsize=20)
        ...
        nx.draw_networkx_edge_labels(self.graph, pos, edge_labels=simple_labels, font_size=8)
