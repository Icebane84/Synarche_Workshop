...
try {
    ...
    // Path: rules/ -> eslint-plugin-phoenix/ -> standards/ -> axion-core/ -> tsconfig.json
    ...
    ALIAS_MAP = Object.entries(tsPaths)
    ...
    console.warn(`[enforce-sovereign-aliases] Failed to load tsconfig.json: ${error.message}`);
}
...
export function create(context) {
    // The context object is provided by ESLint and contains useful utilities
    return {
