...
| :------------------ | :---------------------------- | :---------------- |
| **Artifact ID**     | `ENG-PER-INI-001`             | The Sovereign ID. |
...
> Implemented from Blueprint `GVRN.REG.PersistenceEngine.md`.
> Ethos: Clarity through initialization.
"""

from .insforge_transmuter import InsforgeTransmuter

__all__ = ["InsforgeTransmuter"]
