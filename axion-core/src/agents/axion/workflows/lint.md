...
| :---------------- | :---------------------------- | :---------------- |
| **Artifact ID**   | `ARCH.Prot.Lint`              | The Sovereign ID. |
| **Official Name** | `lint.md`                     | The Filename.     |
...
| Command ID | Action | Impact | | `CMD:LINT --target: "{{target}}"` | Audit artifact against v13.0 rules. | Detects
structural and ethical resonances. |

---

description: Lint an artifact against OGLN v13.1 OMEGA standards

// turbo

1. Run the linter on the target file:

```bash
python c:/Users/Chris/Synarche_Workspace/axion-core/src/hephaestus/sentinel.py "{{target}}"
```

2. Check the output for any CRITICAL errors.
