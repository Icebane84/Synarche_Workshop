...
| :---------------- | :---------------------------- | :---------------- |
| **Artifact ID**   | `ARCH.Prot.Trace`             | The Sovereign ID. |
| **Official Name** | `trace.md`                    | The Filename.     |
...
| Command ID | Action | Impact |
| `CMD:TRACE --target: "{{target}}"` | Invoke dissonance detection agent. | Analyzes semantic resonance vs dissonance. |

---

description: Trace semantic resonance and dissonance

// turbo

1. Invoke the dissonance detection agent:
