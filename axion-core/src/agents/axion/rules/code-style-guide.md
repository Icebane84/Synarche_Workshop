...
trigger: always\*on glob: "\*\*/\_.{md,ts,tsx,py,js}" description: "The Living Constitution of the Phoenix Ecosystem:
Standards for Artifacts, Code, and Governance."
...
This guide is a mandatory constraint for all agentic operations. All artifacts must submit to these standards to
