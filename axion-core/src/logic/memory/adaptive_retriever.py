...
| :---------------- | :-------------------------------- | :---------------- |
| **Artifact ID**   | `CORE.adaptive.retriever`                | The Sovereign ID. |
...
# [OMNI-ARTIFACT-ANCHOR] ID: CORE.adaptive.retriever VER: v15.0 [OMEGA] DOMAIN: CORE STATUS: [CANONIZED] TS: 2026-03-28 HASH: ca587045585182eb
