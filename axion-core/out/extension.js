...
function activate(context) {
    context.subscriptions.push(vscode.commands.registerCommand('axion.traverseSpine', handleTraverseSpine), vscode.commands.registerCommand('axion.reforgeArtifact', handleReforgeArtifact), vscode.commands.registerCommand('axion.executePRG', handleExecutePRG), vscode.commands.registerCommand('axion.pushToForge', handlePushToForge), vscode.commands.registerCommand('axion.traceCausality', handleTraceCausality), vscode.commands.registerCommand('axion.verifyTruth', handleVerifyTruth), vscode.commands.registerCommand('axion.consultOracle', handleConsultOracle), vscode.commands.registerCommand('axion.sentinelScan', handleSentinelScan), vscode.commands.registerCommand('axion.claimAchievement', handleClaimAchievement), vscode.commands.registerCommand('axion.checkLevelStatus', handleCheckLevelStatus), vscode.commands.registerCommand('axion.runBackgroundTask', handleRunBackgroundTask), vscode.commands.registerCommand('axion.generateBriefing', handleGenerateBriefing), vscode.commands.registerCommand('axion.viewAuditLog', handleViewAuditLog), vscode.commands.registerCommand('axion.lookupLore', handleLookupLore), vscode.commands.registerCommand('axion.ingestMindMap', handleIngestMindMap));
}
// --- Command Handlers ---
