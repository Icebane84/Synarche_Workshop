...
OUTPUT_PATH = WORKSPACE_ROOT / "_governance" / "01_Registries" / "GVRN.Registry.Manifest.json"

# Regex for Block A extraction
BLOCK_A_RE = re.compile(r"## \*\*Block A:.*?\*\*\n\n(.*?)\n\n", re.DOTALL | re.IGNORECASE)
...
def sync():
    ...
    logger.info(f"Scanning workspace for metadata locks...")
