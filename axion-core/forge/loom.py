...
ANCHOR_RE = re.compile(r"\[(?:OMNI|GATE)-ANCHOR\] ID: ([\w.-]+) VER: ([\w. \[\]]+) STATUS: ([\w. \[\]]+)", re.IGNORECASE)
                        ...
                        with open(fpath, "r", encoding="utf-8") as f:
                            ...
                            if meta and "artifact_id" in meta:
                                ...
                                if rel_path in path_to_id and path_to_id[rel_path] != aid:
                                    ...
                                    logger.info(f"Deduplicating: Removing old ID {old_id} in favor of {aid} for {rel_path}")
            ...
            try:
                ...
                if official_name:
                    ...
                    if clean_official != clean_actual:
                        logger.warning(f"[COMPLIANCE] {aid}: Name mismatch. Registry: {clean_official} vs Disk: {clean_actual}")
                        dissonance_found = True
