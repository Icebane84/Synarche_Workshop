...
The Phoenix canon has exactly 42 laws. Key rotation is mandatory, but it is a security control extension rather than a new axiom. Treating it as `CTRL-001` gives it `MUST` force without destabilizing the canonical law index.
