...
The Phoenix Schema now has a Governance Configuration Database representation. The 42 laws remain canonical policy
intent, while controls, exceptions, findings, verifications, evidence, risks, metrics, and graph relationships are
first-class objects.
...
This is the point where Phoenix becomes queryable: `LAW-017` can be traversed to its enforcement controls, verification
tests, active findings, exceptions, and evidence without scraping prose.
