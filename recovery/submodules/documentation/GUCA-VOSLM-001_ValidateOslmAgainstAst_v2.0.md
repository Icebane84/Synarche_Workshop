...
| Key | Value |
| :--- | :--- |
| **Module ID** | `GUCA-VOSLM-001_VALIDATEOSLMAGAINSTAST_V2.0` |
| **Version** | `v11.0` |
| **Evolution** | **Cognitive Ascension** |
| **Status** | `ACTIVE` |
---

# GUCA-VOSLM-001_ValidateOslmAgainstAst_v2.0
...
# **GUCA-VOSLM-001_ValidateOslmAgainstAst_v2.0 (v10.0)**
...
# GUCA-VOSLM-001: Validate OSLM Against AST Protocol
...
- **Command ID**: `GUCA-VOSLM-001`
- **Date Initiated**: 2025-11-18
...
`CMD: VALIDATE_OSLM_AGAINST_AST [--report-format:<text|json>]`

| Parameter Name  | Type     | Description                                          | Required |
| :-------------- | :------- | :--------------------------------------------------- | :------- |
| `report-format` | `String` | Output format (`text` for humans, `json` for tools). | Optional |
...
`CMD: VALIDATE_OSLM_AGAINST_AST --report-format:json`
