...
## II. Reusable Mechanics (The "DNA")

### 1. The Psyche Dashboard (Sanity & Resonance)

The `script.js` contains a mature algorithm for handling **Dynamic Madness**:
...
**Status:** **GOLD MINE.** The _math_ for Kaelen's madness is already solved. We do not need to invent the "Insanity
Algorithm," we just need to translate `script.js` into C#/C++.
