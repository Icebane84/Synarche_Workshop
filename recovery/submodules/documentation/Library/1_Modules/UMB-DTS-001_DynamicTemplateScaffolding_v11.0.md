...
| Key | Value |
| :--- | :--- |
| **Module ID** | `UMB-DTS-001_DYNAMICTEMPLATESCAFFOLDING_V11.0` |
| **Version** | `v11.0` |
...
| :------------------ | :--------------------------------------------- |
| **1. Artifact ID** | `UMB-DTS-001` |
| **2. Official Name** | `UMB-DTS-001_DynamicTemplateScaffolding_v11.0.md` |
| **3. Version** | **v11.0** |
| **4. Provenance** | **Genesis Stamp: 2025-12-26** |
| **5. Domain** | `GVRN` (Governance) |
| **6. Evolution** | **Structural Standardization** |
...
> [!IMPORTANT]
> **Dynamic Template Scaffolding (DTS):** This toolkit provides the modular "lego blocks" for building Phoenix-Class artifacts. These blocks ensure every document automatically inherits the system's governance, risk, and linkage logic.
...
## **II. Dynamic Build Blocks (The Toolkit)**
...
## **III. Component Registry Template (SELT-SRS)**

For **Macro-Systems** (Engines), use this registry to list sub-modules.
...
## **IV. Actionable Prompt Packet (The Codex Enforcer)**

Use these prompts to invoke the authority of the Phoenix Codex.
...
**How to Use DTS in Refactoring:**

1. **Evaluate:** Apply `RISK-GOV-BLOCK` and `V-STATE-BLOCK` to candidate artifacts.
2. **Select:** Choose the superior protocol based on Vector Safety.
3. **Refactor:** Paste relevant DTS headers into the new document.
4. **Deprecate:** Mark the losing artifact with a zero Coherence Link Score.
