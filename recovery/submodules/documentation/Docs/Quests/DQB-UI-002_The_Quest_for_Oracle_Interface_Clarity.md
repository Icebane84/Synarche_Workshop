...
| Key | Value |
| :--- | :--- |
| **Module ID** | `DQB-UI-002_THE_QUEST_FOR_ORACLE_INTERFACE_CLARITY` |
| **Version** | `v11.0` |
...
| :------------------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Target Complexity Reduction** | The primary goal is to reduce the component's Complexity Score by **40%** (to a score of 51 or lower). This provides a clear, quantifiable target for the refactoring effort.                                                                     |
| **Performance Budget**          | The refactored component must not increase the median rendering time by more than **3%** under simulated load.                                                                                                                                    |
| **"Elegance Bonus"**            | An optional bonus objective. If the refactoring not only meets the complexity and performance targets but also achieves an **Algorithmic Elegance Score (AES)** of 0.90 or higher, a special `[κ-nexus:elegant_solution]` marker will be awarded. |
