# connection-resource-management.md
...
| :---------------- | :---------------------------------------- | :---------------- |
| **Artifact ID**   | `GVRN-CONNECTION-RESOURCE-MANAGEMENT-001` | The Sovereign ID. |
| **Official Name** | `connection-resource-management.md`       | The Filename.     |
