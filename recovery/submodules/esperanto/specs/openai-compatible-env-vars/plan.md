...
| :---------------- | :---------------------------- | :---------------- |
| **Artifact ID**   | `GVRN-PLAN-001`               | The Sovereign ID. |
| **Official Name** | `plan.md`                     | The Filename.     |
...
**Independent TEST**: Each provider can be configured with its own endpoint using provider-specific env vars, and falls
back to generic ones when specific vars aren't set
...
* [ ] T006 [P] [US2] Add Embedding provider-specific env var tests in
